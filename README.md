...
| [Определение тональности комментариев](toxic_comments_project) | Построение модели машинного обучения для определения токсичных комментариев| *Pandas*, *Scikit-learn*, *NLTK*, *RE*, *CatBoost*, *LightGBM*, NLP |
